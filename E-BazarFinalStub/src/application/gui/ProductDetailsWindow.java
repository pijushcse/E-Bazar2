...
/**
 * Class Description: This class provides detailed information about a selected
 * product. When the user clicks the Browse button on the ProductListWindow
 * screen, the product details for the selected product appear on this screen.
 * In this screen the user has the option to add the product, whose detailed
 * description is given here, to the shopping cart (and if this option is
 * chosen, the CartItemsWindow is invoked).
 */
