...
/**
 * Class Description: This window provides textfields to enter information for
 * payment by credit card. If the user clicks the Proceed With Checkout button,
 * the Terms and Conditions window appears before the Final Order is displayed.
 */
