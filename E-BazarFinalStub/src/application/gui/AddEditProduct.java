...
/**
 * Class Description: This class is responsible for building the window for
...
public class AddEditProduct extends JInternalFrame implements ParentWindow, IComboObserver {
     ...
     *
     * @param addOrEdit - has value "add" or "edit", indicating which gui window
     * will be built
    ...
    public void defineMiddlePanel() {
        ...
        if (isEditMode()) {
            catalogGroupField.setEnabled(false);
        }
    ...
    public String getProductName() {
        return (productNameField != null ? productNameField.getText() : null);
    }

    public String getProductCatalog() {
        return (catalogGroupField != null ? (String) catalogGroupField.getSelectedItem() : null);
    }

    public String getProductUnitPrice() {
        return (pricePerUnitField != null ? pricePerUnitField.getText() : null);
    }

    public String getProductMfgDate() {
        return (mfgDateField != null ? mfgDateField.getText() : null);
    }

    public String getProductAvaiabkeQunatity() {
        return (quantityField != null ? quantityField.getText() : null);
    }
}
