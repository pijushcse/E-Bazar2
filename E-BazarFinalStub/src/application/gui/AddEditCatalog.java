 ...
 * adding or editing a catalog group.
 */
public class AddEditCatalog extends JInternalFrame implements ParentWindow {
    ...
    private final String PRODUCT_NAME = "Catalog Name";
    ...
    /**
     * Constructor sets addOrEdit and catalogGroup instance variables and then
     * builds the gui. Made visible or invisible by calling classes.
     *
