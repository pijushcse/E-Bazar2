...
/**
 *
 * Class Description: This is the entry point into the E-Bazaar application. It
 * is implemented as a JFrame and provides a splash screen. Navigation is by way
 * of a menu bar. This class represents the starting point for all use cases.
 * <p>
 */
public class EbazaarMainFrame extends javax.swing.JFrame implements ParentWindow {
    ...
    /**
     * To switch off background color, and to use default instead, comment out
...
//	 maintain catalogue type menu item
    ...
    public void changeLoggedInMenuText(String label) {
        menuItemLogin.setText(label);
    ...
    /**
     * This method makes sure that the frame is cleaned up and exits when the
     * upper X is clicked
     */
