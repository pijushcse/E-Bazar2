...
/**
 * Class Description: This class presents a table of all catalogs available in
 * the database, and allows the user to add edit or delete groups. Not all
 * functionality for these buttons is implemented on initial creation of this
 * class.
 */
    ...
    private void updateModel() {
        ...
        if (USE_DEFAULT_DATA) {
            ...
            try {
                ...
                updateModel(catalogNames);
            } catch (DatabaseException ex) {
                Logger.getLogger(MaintainCatalogTypes.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
